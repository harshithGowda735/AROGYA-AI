...
import { ArrowLeft, Download, FileText, User, MapPin, Activity, Calendar, Shield, Database, Cloud } from 'lucide-react-native';
...
<body>
  ...
  <div class="section">
    ...
    <div class="field"><span class="field-label">Inference Engine</span><span class="field-value">DermAI Engine v2.5</span></div>
    <div class="field"><span class="field-label">Processing Mode</span><span class="field-value">High Performance</span></div>
    <div class="field"><span class="field-label">Confidence Score</span><span class="field-value">95.0%</span></div>
  ...
  <div class="disclaimer">
    <div class="disclaimer-text">
      <strong>Disclaimer:</strong> This report is generated by DermAI for preliminary screening purposes only. 
  ...
  <div class="footer">
    <div class="footer-text">DERMAI DIAGNOSTIC INTELLIGENCE • AROGYA AI INITIATIVE</div>
  ...
  const handleMongoSync = async () => {
    setSyncing(true);
    // Simulate MongoDB / PostgreSQL sync
    setTimeout(() => {
      setSyncing(false);
      Alert.alert('Cloud Sync Success', 'Diagnostic report securely synced to MongoDB Cluster.');
    }, 2000);
  };
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={styles.syncText}>
            {syncing ? 'SYNCING TO MONGODB...' : 'SYNC TO CLOUD DATABASE'}
          </Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  syncBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: 'rgba(0,229,255,0.05)', borderRadius: 18,
    paddingVertical: 18, gap: 12, marginTop: 12,
    borderWidth: 1, borderColor: 'rgba(0,229,255,0.2)',
  },
  syncBtnDisabled: { opacity: 0.5 },
  syncText: { color: '#00E5FF', fontSize: 11, fontWeight: '900', letterSpacing: 2 },
